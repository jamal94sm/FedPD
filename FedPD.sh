...
python main.py --local_model_name "ResNet18" --dataset "cifar10" --num_train_samples 10000 --alpha_dirichlet 10 --rounds 30 --num_synth_img_per_class 100 --output_name "_RN18_CFR10_10K_A10_synth100_"
