...
python main.py --local_model_name "ResNet18" --dataset "cifar10" --num_train_samples 10000 --alpha_dirichlet 0.1 --rounds 40 --num_synth_img_per_class 100 --output_name "_RN18_10K_A0.1_synth100_"
